  ...
  <section class="hero text-center">
        <div class="container">
            <div class="col-md-12">
                ...
                <form action="<?php echo e(url('links/store')); ?>" id="link_store" method="POST">
                    <div class="alert" id="link_message">
...
<?php echo $__env->make('web.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\LiteProject\views/web/home/index.blade.php ENDPATH**/ ?>